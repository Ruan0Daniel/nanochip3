...
define('USUARIO', 'nanochip');	// Define uma constante com o nome 'USUARIO' com o valor 'root' (login do banco de dados)
define('SENHA', 'nanochip2021');	// Define uma constante com o nome 'SENHA' com o valor '' (senha do banco de dados)
